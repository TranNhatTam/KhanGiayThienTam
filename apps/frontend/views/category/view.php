...
/* @var $categories array|\common\models\Brand[]|\common\models\Category[]|\common\models\Product[]|\yii\db\ActiveRecord[] */
/* @var $brands array|\common\models\Brand[]|\common\models\Category[]|\common\models\Product[]|\yii\db\ActiveRecord[] */
/* @var $product array|\common\models\Brand[]|\common\models\Category[]|\common\models\Product[]|\yii\db\ActiveRecord[] */
...
$("input[type=checkbox]").on("change", function(){
        ...
        $.ajax({
            'url':'/category/sort-product-by-brand',
            'method':'GET',
            'data':{
                'urlId':$urlId,
                'format':'',
