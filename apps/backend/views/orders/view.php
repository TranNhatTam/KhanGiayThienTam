...
//                                'unit_price',
                    ...
                    <div class="add-more-product" style="display: none">
                        ...
                        <div class="input-group" style="width: 250px">
                            <input type="number" id="inputQuantity" class="form-control" name="quantity" placeholder="Nhập số lượng...."
                        ...
                        <div class="col-md-6">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <?php
                                            $orderDetail = \common\models\OrderDetails::find()->where(['order_id'=>$model->id])->all();
                                            $totalPrice = 0;
                                            $totalDiscount = 0;
                                            $totalTax = 0;
                                        ...
                                        <tr>
                                            <td class="text-right no-border"><strong>Số tiền phải thanh toán</strong><br><?=$model->description?></td>
                                            <td class="text-right no-border"><strong><?=number_format($finalPrice).' đ'?></strong></td>
                                        </tr>
<!--                                        <tr>-->
<!--                                            <td class="text-right">Số tiền đã thanh toán</td>-->
<!--                                            <td class="text-right">60000</td>-->
<!--                                        </tr>-->
<!--                                        <tr>-->
<!--                                            <td class="text-right no-border">Số tiền đã hoàn trả</td>-->
<!--                                            <td class="text-right no-border">0</td>-->
<!--                                        </tr>-->
<!--                                        <tr>-->
<!--                                            <td class="text-right no-border">Số tiền thực nhận</td>-->
<!--                                            <td class="text-right no-border">60000</td>-->
<!--                                        </tr>-->
                    ...
                    <div style="border-top: solid 1px lightgrey;padding: 10px 20px 20px 20px">
                        <div>
                            ...
                            <a href="javascript:;" class="text-center pull-right" data-toggle="modal"
                               data-target="#myModal" style="padding-top: 10px;padding-right: 20px;font-size: 18px"><i class="fa fa-pencil"></i></a>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo Editable::widget([
                                        ...
                                        'data' => [0 => 'Chưa giao hàng', 1 => 'Đã giao hàng'],
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo Editable::widget([
                                        ...
                                        'format' => Editable::FORMAT_BUTTON,
                                        'inputType' => Editable::INPUT_DROPDOWN_LIST,
                                        'data' => [0 => 'Chưa thanh toán', 1 => 'Đã thanh toán'],
                                        'options' => ['class'=>'form-control', 'prompt'=>'Chọn trạng thái...'],
                                        'displayValueConfig'=> [
                                            '0' => 'Chưa thanh toán',
                                            '1' => 'Đã thanh toán',
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo Editable::widget([
                                        ...
                                        'format' => Editable::FORMAT_BUTTON,
                                        'inputType' => Editable::INPUT_DROPDOWN_LIST,
                                        'data' => [Orders::STATUS_PENDING => 'Chờ xử lý',Orders::STATUS_PROCESSED => 'Đã xử lý',Orders::STATUS_FINISHED => 'Đã hoàn thành',Orders::STATUS_CANCELLED => 'Đã hủy'],
                                        'options' => ['class'=>'form-control', 'prompt'=>'Chọn trạng thái...'],
                                        'displayValueConfig'=> [
                                            Orders::STATUS_PENDING => 'Chờ xử lý',Orders::STATUS_PROCESSED => 'Đã xử lý',Orders::STATUS_FINISHED => 'Đã hoàn thành',Orders::STATUS_CANCELLED => 'Đã hủy'
                                        ],
                                        'formOptions' => [
